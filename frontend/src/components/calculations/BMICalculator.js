                    ...
                    <div className="Interest-Section-container">
                        ...
                        <div className="Interest-container">
                            ...
                            <div className="Interest-container-section1">
                                ...
                                <input type="number" className="form-control" id = "rateOfInterest" required maxLength={10} name = "height" value={calculateBMI.height} onFocus={ (e) => e.target.value = calculateBMI.height==0? '' : calculateBMI.height} onBlur ={(e) => e.target.value = calculateBMI.height} onChange={handleChange} /> <br/>
