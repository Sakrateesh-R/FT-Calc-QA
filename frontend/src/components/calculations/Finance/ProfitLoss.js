            ...
            <div className="Profit-container">
                <div className="Profit-body">
                    ...
                    <div className="Profit-input-section">
                        ...
                        <input type="number" className="form-control" name="SellingPrice" value={calculateProfit.SellingPrice} onChange={handleChange} id = "sellingPrice" onFocus={ (e) => e.target.value= calculateProfit.SellingPrice==0? '': calculateProfit.SellingPrice} onBlur ={(e) => e.target.value =calculateProfit.SellingPrice} />
